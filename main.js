...
const Satellite_overview=[
  "地球のオゾン層、空気の質、気候を観測する。オーラはテラ（1999年打上げ）とアクア（2002年打上げ）に続く、地球観測システム（EOS）プロジェクト用の3機目の人工衛星です。2004年7月15日、ヴァンデンバーグ空軍基地からデルタIIロケットによって打ち上げられた。オーラはその他の衛星とA-Trainという衛星コンステレーションを構成する",
  "国際宇宙ステーション（ISS）は、地上から約400km上空に建設された巨大な有人実験施設です。1周約90分というスピードで地球の周りを回りながら、実験・研究、地球や天体の観測などを行っています。",
  "ICON (Ionospheric Connection Explorer、Explorer-96) はアメリカ航空宇宙局(NASA)によって2019年に打ち上げられた科学衛星。宇宙と地球の境界に広がる電離層及び熱圏を観測し、地球大気の気象と大気上層を電離させる太陽由来のエネルギーがこの領域にどのような相互作用を及ぼしているかを研究しています。エクスプローラー計画に含まれる中型探査機シリーズMIDEX(medium-class Explorer)の1機です（MIDEX-8）。",
  ...
  "SAC-Aはアルゼンチンの技術衛星。科学利用衛星S(SAC-A)は、STS-88スペースシャトル・エンデバー号のミッション中に打ち上げられたアルゼンチンの小型で低コストの射出式衛星です。アルゼンチンのCONAEのためにINVAPが製作した実験用地球観測衛星。1998年に打ち上げられました。",
  "ORFEUSは、ガス状の星間雲の研究と同時に、恒星がどのように生まれ、どのように死ぬかの情報を得られるように設計された。熱い銀河や星間物質の高解像度観測のためのORFEUS望遠鏡が搭載されています",
